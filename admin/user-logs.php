        ...
        <div class="main-panel">
            ...
            <div class="container">
                <div class="page-inner">
                    ...
                    $sql_count = "SELECT COUNT(*) AS total_logs FROM student_logs";
                    ...
                    $sql_logs = "SELECT student_id, action, date 
                    FROM student_logs 
                                    ...
                                    <div class="d-flex">
                                        ...
                                        <div class="flex-1 ms-3 pt-1">
                                            <h6 class="text-uppercase fw-bold mb-1">
                                                <?php
                                                echo htmlspecialchars($log['student_id']); // Otherwise, display the student_id
                                                ?>
                                            </h6>
